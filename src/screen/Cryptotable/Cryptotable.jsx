...
const Cryptotable = () => {
    return (
        <div className='p-4  w-100   overflow-auto dashboardStyle'>
            <div >
                <Table className='table-black  table-dark TextSize ' responsive="xl"   >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className=' TextSize fw-light TextSize '> <i class="fa-solid fa-chevron-up  text-danger me-1" />
                                <span className=' text-danger'>22.49%</span></td>
                            <td className='fw-light TextSize '> $7666,432,562,346</td>
                            <td className='fw-light TextSize '>$38,544,965,954</td>
                            <td className='fw-light TextSize '>18,434,356 BTC</td>
                        </tr>
